...
module.exports = function (level) {
  ...
  return {
    ...
    api: {
      ...
      starsByHolder: function (core, holder, opts = {}) {
        return pullLevel.read(level, Object.assign({
          keys: false,
          gte: STARS + holder + '!',
          lte: STARS + holder + '!' + '~'
      ...
      starredFilesByHolder: function (core, holder, opts = {}) {
        return pull(
          core.api.files.starsByHolder(holder, opts),
          pull.asyncMap(core.api.files.get)
        )
      },
      commentsByHolder: function (core, holder, opts = {}) {
        return pullLevel.read(level, Object.assign({
          gte: COMMENTS + holder + '!',
          lte: COMMENTS + holder + '!' + '~'
        }, opts))
      },
      commentedFilesByHolder: function (core, holder, opts = {}) {
        return pull(
          core.api.files.commentsByHolder(holder, opts),
          pull.asyncMap(core.api.files.get)
        )
      },
      events: events
