...
module.exports = class Server extends EventEmitter {
  constructor (feed, options) {
    ...
    this.feed.on('peer-open', (peer) => {
      ...
      console.log(' **** read queue ', peer.stream.stream._readableState.queue.isEmpty())
      console.log(' **** buffered ', peer.stream.stream._readableState.buffered)
  ...
  async _upload (request, peer) {
    ...
    console.log(' **** init queue ', peer.stream.stream._writableState.queue.isEmpty())
