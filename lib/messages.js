...
function defineMetadbMessage () {
  ...
  function encodingLength (obj) {
    var length = 0
    if ((+defined(obj.addFile) + +defined(obj.fileComment) + +defined(obj.rmFiles) + +defined(obj.invite) + +defined(obj.about) + +defined(obj.header)) > 1) throw new Error("only one of the properties defined in oneof msg can be set")
